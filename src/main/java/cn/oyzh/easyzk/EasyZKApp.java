...
public class EasyZKApp extends FXApplication implements EventListener {
    ...
    public void start(Stage primaryStage) {
        try {
            ...
            // 注册命令
            TerminalManager2.setLoadHandlerAction(ZKTerminalManager::registerHandlers);
            // 显示迁移弹窗
...
//        }
    ...
    protected void initSystemTray() {
        try {
            ...
            // 打开主页
            TrayManager.addMenuItem(new DesktopTrayItem("12", ZKViewFactory::main));
            // 打开设置
            TrayManager.addMenuItem(new SettingTrayItem("12", ZKViewFactory::setting));
            // 退出程序
