 ...
 * @since 2023/1/30
 */
public class ZKInformationTreeItem extends RichTreeItem<ZKInformationTreeItem.ZKInformationTreeItemValue> {

    public ZKInformationTreeItem(RichTreeView treeView) {
        super(treeView);
