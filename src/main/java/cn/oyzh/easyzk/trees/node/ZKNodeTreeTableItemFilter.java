 ...
 * @since 2023/3/28
 */
public class ZKNodeTreeTableItemFilter implements RichTreeTableItemFilter {
    ...
    @Override
    public boolean test(RichTreeTableItem<?> item) {
        // 根节点直接展示
        if (item instanceof ZKNodeTreeTableItem treeItem) {
            // 根节点不参与过滤
            if(treeItem.isRoot()){
                return true;
            }
